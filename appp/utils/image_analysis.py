...
def analyze_image(base64_image, spoken_text):
    ...
    try:
        ...
        image_prompt_parts = [
            ...
            - Recycling (Tool B): Choose this if the image features any item/product in a home/outdoor setting. This may be items that are complex to recycle like devices, laptops, appliances, or everyday items like paper, bags, etc. The presence of any such item suggests a need for detailed recycling information.
