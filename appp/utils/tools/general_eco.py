...
# this file houses the function to generate a general eco related response and give those insights from the image if the image analysis deems it to most valuable for general ecology insights
